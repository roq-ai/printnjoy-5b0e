...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`PrintnJoy`}</title>

        <meta
          name="description"
          content="Welcome to PrintnJoy, where creativity meets functionality. Unleash your design potential and transform everyday items into unique masterpieces."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1661956600684-97d3a4320e45?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MXwxfHNlYXJjaHwxfHxkZXNpZ258ZW58MHx8fHwxNjkwMjEyNTk2fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to PrintnJoy, where creativity meets functionality. Unleash your design potential and transform everyday items into unique masterpieces.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                <Card userTypeName="Design Contributor" type="design-contributor" />
